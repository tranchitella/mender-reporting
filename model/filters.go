...
func (f FilterPredicate) ValueType() (Type, bool, error) {
	...
	case []interface{}:
		...
		case string:
			break
		default:
			return 0, false, errors.New(fmt.Sprintf("unknown attribute value type: %v %T", ival[0]))
		}
	default:
		return 0, false, errors.New(fmt.Sprintf("unknown attribute value type: %v %T", f.Value))
